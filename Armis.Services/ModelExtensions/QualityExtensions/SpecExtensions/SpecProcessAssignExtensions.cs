    ...
    public static class SpecProcessAssignExtensions
    {
        ...
        public static SpecProcessAssign ToEntity(this SpecProcessAssignModel aSpecProcessAssignModel)
        {
            return new SpecProcessAssign()
            {
                ...
                SubLevelOption1 = 1, //All subLevelOptions are part of a Check constraint in SQL the entity framework isn't handling, these values MUST be 1 - 6.  TODO:Revisit this once entity framework scaffolds Check Constraints correctly.
